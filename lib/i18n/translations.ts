...
export const translations = {
  ru: {
    ...
    continueToQuizzes: "Продолжить к тестам",
    surveyTitle: "Введите свои данные",
    surveySubtitle: "Заполните анкету перед началом тестирования",
    schools: "Школы",
    addSchool: "Добавить школу",
    schoolName: "Название школы",
    schoolAdded: "Школа добавлена",
    schoolDeleted: "Школа удалена",
    schoolNamePlaceholder: "Например: №7 школа-гимназия",
    confirmDeleteSchool: "Вы уверены, что хотите удалить эту школу?",
    duplicateSchool: "Школа с таким названием уже существует",
    noSchools: "Нет школ",
  ...
  kk: {
    ...
    continueToQuizzes: "Тесттерге өту",
    surveyTitle: "Деректеріңізді енгізіңіз",
    surveySubtitle: "Тестілеуді бастамас бұрын сауалнаманы толтырыңыз",
    schools: "Мектептер",
    addSchool: "Мектеп қосу",
    schoolName: "Мектеп атауы",
    schoolAdded: "Мектеп қосылды",
    schoolDeleted: "Мектеп жойылды",
    schoolNamePlaceholder: "Мысалы: №7 мектеп-гимназия",
    confirmDeleteSchool: "Бұл мектепті жоюға сенімдісіз бе?",
    duplicateSchool: "Бұл атаумен мектеп бұрыннан бар",
    noSchools: "Мектептер жоқ",
